...
main(int , char **argv)
{
   ...
   SoSeparator *plane1Sep = new SoSeparator;
   ...
   plane1Sep->addChild(texPlane1);
   plane1Sep->addChild(new SoSphere);
   root->addChild(plane1Sep);
   ...
   SoSeparator *plane2Sep = new SoSeparator;
   ...
   plane2Sep->addChild(texPlane2);
   plane2Sep->addChild(new SoSphere);
   root->addChild(plane2Sep);
   root->addChild(myTranslation);

   // The third sphere has a repeat frequency of .5
   SoSeparator *plane3Sep = new SoSeparator;
   ...
   plane3Sep->addChild(texPlane3);
   plane3Sep->addChild(new SoSphere);
   root->addChild(plane3Sep);
